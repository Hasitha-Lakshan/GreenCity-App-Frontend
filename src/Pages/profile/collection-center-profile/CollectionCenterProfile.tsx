...
export const CollectionCenterProfile = (props: any) => {
    ...
    return (
        <>
                ...
                <div className="col-xl-9 col-lg-8 col-md-7 col-sm-12 pt-3">
                    ...
                    <div className="text-left profile-settings">
                        <div className="row">
                            ...
                            <div className="col"><h5>{profileSettings.username}</h5></div>
                        </div>
                        <hr className="my-2" />
                        <div className="row">
                            <div className="col col-xl-3 col-lg-3 col-sm-4 text-secondary"><h5>Email :</h5></div>
                            <div className="col"> <h5>{profileSettings.email}</h5></div>
                        </div>
                        <hr className="my-2" />
                        <div className="row">
                            <div className="col col-xl-3 col-lg-3 col-sm-4 text-secondary"><h5>Mobile Number :</h5></div>
                            <div className="col"><h5>{profileSettings.contactNumber}</h5></div>
                        </div>
                        <hr className="my-2" />
                        <div className="row">
                            <div className="col col-xl-3 col-lg-3 col-sm-4 text-secondary"> <h5>Address :</h5></div>
                            <div className="col">
                                <h5> {`${profileSettings.addressLine1}, ${profileSettings.addressLine2}, ${profileSettings.addressLine3}`}</h5>
                            </div>
                        </div>
                        <hr className="my-2" />
                        <div className="row">
            ...
            {/* Settings modal */}
            <CollectionCenterProfileSettings isShowModal={showSettingsModal} hideModal={hideModals} />
            {/* Details Modal */}
            <CollectionCenterProfileDetails isShowModal={showDetailsModal} hideModal={hideModals} />
        </>
    )
}
